                                ...
                                <div className="flex flex-col gap-8">
                                    ...
                                    <div className="space-y-4 pt-4 border-t border-white/5">
                                        ...
                                        <div className="flex items-center gap-4">
                                            ...
                                            <span className="text-[10px] text-gray-400 font-bold uppercase tracking-widest">Digital Mailroom Active</span>
                                        </div>
                                    </div>
                                </div>
                             )}
                    ...
                    <>
                        <div className="relative z-10 flex justify-between items-start">
                             <div>
                                ...
                                <p className="text-white/60 font-medium text-sm">Your Public Shield for Privacy & Communications</p>
                             </div>
                             {/* PRIVACY RADAR VISUAL */}
                             <div className="w-24 h-24 relative flex items-center justify-center group">
                                ...
                                <div className="absolute inset-0 rounded-full border-t border-luminous-blue/50 animate-[spin_3s_linear_infinite] opacity-50 shadow-[0_0_15px_rgba(0,122,255,0.3)]" />
                                
                                {/* Pulsing Signal (Ping) */}
                                <div className="absolute inset-0 rounded-full border border-luminous-blue/20 animate-ping opacity-20" />
                                
                                {/* Inner Core */}
                                <div className="relative z-10 w-12 h-12 bg-[#0A0A0B] rounded-full border border-white/10 flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-500">
                                    <ShieldCheck size={20} className="text-luminous-blue" />
                                </div>
                                
                                {/* Status Dot */}
                                <div className="absolute top-1 right-3 w-2 h-2 bg-[#00D084] rounded-full animate-pulse shadow-[0_0_8px_#00D084]" />
                             </div>
                        </div>
