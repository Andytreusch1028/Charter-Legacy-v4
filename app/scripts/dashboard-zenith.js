        ...
        <div style="display: flex; gap: 3rem; margin-top: 3rem; padding: 1.5rem 0; border-top: 1px solid #eee; border-bottom: 1px solid #eee;">
            <div>
                ...
                <div style="display: flex; align-items: center; gap: 8px;">
                    ...
                    <span style="font-size: 0.95rem; font-weight: 700; color: #111;">${isProtected ? 'Protected' : 'Exposed'}</span>
                </div>
            </div>
            ...
            ${hero.product_type === 'medical_pllc' ? `
                <div>
                    <div style="font-size: 0.6rem; font-weight: 700; text-transform: uppercase; letter-spacing: 0.15em; color: #aaa; margin-bottom: 0.5rem;">Medical Board</div>
                    <div style="display: flex; align-items: center; gap: 8px;">
                        ...
                        <span style="font-size: 0.95rem; font-weight: 700; color: #111;">Credentialed</span>
                    </div>
                </div>
                <div>
