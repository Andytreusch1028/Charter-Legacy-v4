...
async function checkAuthAndLoadData() {
    ...
    setTimeout(() => {
        ...
        // Updated selector to match .skeleton-hero shell
        if (entityList && (entityList.querySelector('.skeleton-hero'))) {
            console.warn("CL: Entity load timeout. Forcing mock data.");
            loadMockData();
        }
    }, 2000);
}
    ...
    if (entities && entities.length > 0) {
        ...
        entityList.innerHTML = `
            <div class="entity-hero animate-in fade-in slide-in-from-bottom-4 duration-1200" style="padding: 0;">
                ...
                <h2 class="hero-name" style="font-weight: 950; font-size: clamp(1.2rem, 5vw, 2.8rem) !important; white-space: nowrap;">${hero.llc_name}</h2>
                ...
                <div class="card-actions" style="margin-top: 3rem; display: flex; flex-direction: column; gap: 0.75rem; width: 220px;">
                        ...
                        ${secondary.map(entity => `
                            <div class="llc-card">
                                ...
                                <div class="card-actions" style="margin-top: auto; padding-top: 1.5rem;">
                                    <a href="/app/documents?entity_id=${entity.id}" class="btn-pill" style="padding: 0.6rem 2rem; font-size: 0.8rem; width: auto; align-self: flex-start; background: rgba(0,0,0,0.04); border: none;">
                                        Manage Vault &rarr;
                                    </a>
                                </div>
                            </div>
