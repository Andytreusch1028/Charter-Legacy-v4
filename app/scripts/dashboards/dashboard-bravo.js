    ...
    if (entities && entities.length > 0) {
        ...
        entityList.innerHTML = `
            <div class="entity-hero animate-in fade-in slide-in-from-bottom-4 duration-1200" style="padding: 0;">
                ...
                <h2 class="hero-name" style="font-weight: 1000 !important; font-size: 3.4rem !important; white-space: nowrap; letter-spacing: -0.065em !important; line-height: 0.95;">${hero.llc_name}</h2>
                ...
                <div class="hero-meta" style="margin-top: 2rem; border-top: 1px solid rgba(0,0,0,0.05); border-bottom: 1px solid rgba(0,0,0,0.05); padding: 2rem 0;">
                    <div class="meta-item">
                        ...
                        <span class="meta-value" style="font-size: 0.8rem;">FL-605.0113</span>
                    </div>
                    <div class="meta-item">
                        <span class="meta-label" style="opacity: 0.3;">Privacy Shield:</span>
                        <span class="meta-value" style="font-size: 0.8rem;">${hero.privacy_shield ? 'Enabled (Hub Node)' : 'Standard'}</span>
                    </div>
                    <div class="meta-item">
                        <span class="meta-label" style="opacity: 0.3;">Compliance:</span>
                        <span class="meta-value" style="font-size: 0.8rem; color: #34C759;">Optimal</span>
                    </div>
                </div>
